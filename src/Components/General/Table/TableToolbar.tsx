...
import { TableMouseEventHandler } from '../../../../types/react-table'
import { ColumnHidePage } from './ColumnHidePage'
import { FilterPage } from './FilterPage'
import {AddCompanyPriorityPage} from "./AddCompanyPriorityPage";
import {useState as useState2, State} from "@hookstate/core";
...
export function TableToolbar<T extends Record<string, unknown>>({
  ...
  const state: State<CompanyPriority> = useState2({ company: '', priority: 0 } as CompanyPriority);
  ...
  const resetNewCompanyPriority = () => {
    state.company.set("");
    state.priority.set(0);
  }
  ...
  return (
    <Toolbar className={classes.toolbar}>
      <div className={classes.leftButtons}>
        <AddCompanyPriorityPage<T> instance={instance} onClose={handleClose} show={addOpen} anchorEl={anchorEl} companyPriorityItem={state} />
